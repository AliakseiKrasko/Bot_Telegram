...
from less2.keyboards.prof_keyboards import make_row_keyboard
...
async def prof_chosen(message: types.Message, state: FSMContext):
    ...
    await message.answer(f'Спасибо, Теперь выбери свой уровень', reply_markup=make_row_keyboard(available_prof_grades))
